...
var WeekdayDateRangePicker = function(param) {
    ...
    var _useState7 = _sliced_to_array(useState([]), 2), calendarMonths = _useState7[0], setCalendarMonths = _useState7[1];
    var _useState8 = _sliced_to_array(useState([]), 2), calendarYears = _useState8[0], setCalendarYears = _useState8[1];
    var _useState9 = _sliced_to_array(useState(null), 2), hoveredDate = _useState9[0], setHoveredDate = _useState9[1];
    var _useState10 = _sliced_to_array(useState([]), 2), selectedHoveringDates = _useState10[0], setSelectedHoveringDates = _useState10[1];
    var _useState11 = _sliced_to_array(useState(null), 2), focusedDate = _useState11[0], setFocusedDate = _useState11[1];
    var instructionsId = useId();
        ...
        children: [
            /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                    ...
                    showTimeZoneLabel && /* @__PURE__ */ jsxs("div", {
